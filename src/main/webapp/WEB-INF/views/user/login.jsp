...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath }/res/layuiadmin/layui/css/layui.css" media="all">
  <link rel="stylesheet" href="${pageContext.request.contextPath }/res/layuiadmin/style/admin.css" media="all">
  <link rel="stylesheet" href="${pageContext.request.contextPath }/res/layuiadmin/style/login.css" media="all">
</head>
<body>
