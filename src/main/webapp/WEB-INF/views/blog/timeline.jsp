						...
						<div class="my-timeline">
							<ul class="layui-timeline">
								<li class="layui-timeline-item"><i
									...
									<div class="layui-timeline-content bgc-fff layui-text">
										<h3 class="layui-timeline-title">
											<a href="#">标题</a>
										</h3>
										<div class="my-article-meta">
											<span class="layui-badge layui-bg-red">推荐</span>
											<div class="my-article-date ">
												<i class="layui-icon layui-icon-date"></i> <a href="">2019-05-16</a>
											</div>
											<div class="article-tag ">
												<i class="layui-icon layui-icon-note"></i> <a href="">#java</a>,
												<a href="">#java</a>
											</div>
										</div>
